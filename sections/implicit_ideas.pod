...
The default scalar variable, C<$_>, is the best example of a linguistic
shortcut in Perl.  It's most notable in its I<absence>: many of Perl's built in
operations perform their work on the contents of C<$_> in the absence of an
explicit variable.  You can still use C<$_> as the variable, but it's often
unnecessary.
...
functions.  The array operators C<shift> and C<pop> operate on C<@_> with no
other operands provided.
